...
* The original package name 'com.example.HyperLedger-TransferCoin' is invalid and this project uses 'com.example.HyperLedgerTransferCoin' instead.
...
```
$ docker run --rm -p 8080:8080 HyperLedger-TransferCoin:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/HyperLedger-TransferCoin
```
